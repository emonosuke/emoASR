""" transformers v3.0.0
https://github.com/huggingface/transformers/tree/b62ca59527de4e883fb8e91f02e97586115616b1
"""
...
from .configuration_transformers import TransformersConfig
...
class BertPreTrainedModel(PreTrainedModel):
    ...
    config_class = TransformersConfig
...
class BertModel(BertPreTrainedModel):
    ...
    Return:
        ...
        extended_attention_mask: torch.Tensor = self.get_extended_attention_mask(
            attention_mask, input_shape, device, causal=causal
        )
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    Examples::
        ...
        if labels is not None and next_sentence_label is not None:
            ...
            total_loss = lm_loss + next_sentence_loss
